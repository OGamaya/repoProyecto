 ...
 * @generated
 */
public class ProjectTourSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case ProjectTourPackage.ROT_PANORAMA: {
			RotPanorama rotPanorama = (RotPanorama) theEObject;
			T result = caseRotPanorama(rotPanorama);
			if (result == null)
				result = caseCoordinate(rotPanorama);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ProjectTourPackage.ROTATION: {
			...
			if (result == null)
				result = caseCoordinate(rotation);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case ProjectTourPackage.COORDINATE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Rot Panorama</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Rot Panorama</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseRotPanorama(RotPanorama object) {
		return null;
	}
